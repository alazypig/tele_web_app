...
class TeleWebApp extends JsObjectWrapper<tele.WebAppJsImpl> {
  ...
  SafeAreaInset get safeAreaInset =>
      SafeAreaInset.fromJsObject(jsObject.safeAreaInset);
  ...
  // API >= 7.7+
  void enableVerticalSwipes() => jsObject.enableVerticalSwipes();

  // API >= 7.7+
  void disableVerticalSwipes() => jsObject.disableVerticalSwipes();

  // API >= 8.0
  void requestFullscreen() => jsObject.requestFullscreen();
  ...
  void showPopup({required PopupParams params, Function? callback}) =>
      jsObject.showPopup(params.jsObject, allowInteropOrNull(callback));
}
...
class SafeAreaInset extends JsObjectWrapper<tele.SafeAreaInsetJsImpl> {
  SafeAreaInset.fromJsObject(super.jsObject);
...
class ContentSafeAreaInset
    extends JsObjectWrapper<tele.ContentSafeAreaInsetJsImpl> {
  ContentSafeAreaInset.fromJsObject(super.jsObject);
...
class WebAppInitData extends JsObjectWrapper<tele.WebAppInitDataJsImpl> {
  ...
  // chart type: private | group | supergroup | channel
  String? get chartType => jsObject.chart_type;

  // chart instance
  String? get chartInstance => jsObject.chart_instance;
  ...
  String get signature => jsObject.signature;
}
...
class WebAppUser extends JsObjectWrapper<tele.WebAppUserJsImpl?> {
  ...
  bool get addedToAttachmentMenu => jsObject?.added_to_attachment_menu ?? false;
...
class WebAppChat extends JsObjectWrapper<tele.WebAppChatJsImpl?> {
  ...
  int get id => jsObject!.id.toInt();
  String get type => jsObject!.type; // group | supergroup | channel
  String get title => jsObject!.title;
  String? get username => jsObject?.username;
  String? get photo_url => jsObject?.photo_url;
}
